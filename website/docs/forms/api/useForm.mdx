...
| Parameter          | Type                                                    | Default                    | Description                                                                                                                                                                                                                                     |
| ------------------ | ------------------------------------------------------- | -------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| formatErrorMessage | `(error: ZodIssue, value: any, name: string) => string` | `(error) => error.message` | A function to overwrite the default error message from Zod. Receives the Zod issue, the current value and the name of the field.<br/>See [useField – formatErrorMessage](/forms/api/useField#formatErrorMessage) for more details and examples. |
...
| options   | [Options](/forms/api/useField#options) | Initial field data and additional configuration options.<br/>See [useField](/forms/api/useField#options) for more details. Takes all options except for `name` and `formatErrorMessage`. |

#### Returns // useFormField-returns

(`Object`) See [useField](/forms/api/useField#returns) for the return type.
