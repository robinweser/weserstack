...
Doing so, we'll use the [useForm](/forms/api/useForm) hook with the provided schema to create all the form utils.
...
For this guide, we'll just use the [inputProps](/forms/api/useField#inputProps) to pass to the input fields. You can of course create your own components based on any data provided by the field object.
...
This is what the [handleSubmit](/forms/api/useForm#handleSubmit) and [reset](/forms/api/useForm#reset) functions is for.
