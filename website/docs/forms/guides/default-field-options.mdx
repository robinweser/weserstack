...
Each field, takes a couple of [options](/forms/api/useField#options) that can be used to configure the field.<br />
They're applied by passing an options object as a second argument.

> **Note:** Make sure to check the [Fields](/forms/basics/fields) guide to understand the different states and properties of a field.
