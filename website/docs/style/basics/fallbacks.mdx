...
Now, since this is very cumbersome to write, this package provides a [plugin](/style/api/plugins/fallbackValue) that can be used to automatically add fallbacks to the style object.
