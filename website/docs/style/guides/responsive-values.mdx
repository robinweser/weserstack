...
First of all, we need to create our renderer and make sure to pass the [responsiveValuePlugin](/style/api/plugins/responsiveValue) to it.
...
In order to pass responsive values, we need to use the [responsiveValue](/style/api/responsiveValue) function.<br />
...
We can achieve this by utilizing the [T_ResponsiveValue](/style/api/types/T_ResponsiveValue) type.

```tsx
import { PropsWithChildren } from 'react'
import { T_ResponsiveValue, T_Style } from '@weser/style'
