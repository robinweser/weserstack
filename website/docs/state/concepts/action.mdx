...
> **Note**: Actions may also return an optional second item. Read more about [effects](/state/concepts/effect).

## Principles

Since we [can't enforce immutability nor pure functions in JavaScript](/state/design-principles), here are some recommendations on how to write good actions:
