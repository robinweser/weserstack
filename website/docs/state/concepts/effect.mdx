...
Apart from pure state updates, this package also supports side effects out of the box.
...
But it doesn't have to be like that! In order to prevent that, effects in this package are very limited making it much safer without loosing the flexibility:
