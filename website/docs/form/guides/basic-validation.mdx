...
Another way is to use the [formatErrorMessage](/form/api/useField#formaterrormessage) option when creating the field.
...
It works with both [useField](/form/api/useField) as well as [useForm](/form/api/useForm).
